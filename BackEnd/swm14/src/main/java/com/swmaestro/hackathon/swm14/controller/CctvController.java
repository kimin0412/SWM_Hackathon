...
public class CctvController {
	public static final Logger logger = LoggerFactory.getLogger(CctvController.class);
	...
	@GetMapping("/all")
	public ResponseEntity<HashMap<String, Object>> getAllCCTVs(HttpServletRequest request) throws Exception {
	...
	public ResponseEntity<HashMap<String, Object>> getRangeCCTVs(@PathVariable("lat1") double lat1,
